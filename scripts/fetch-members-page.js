async function run() {
  ...
  console.log("Step 3: Fetching admin/users page...");
  const response3 = await fetch('https://vanigan.digital/admin/users', {
    headers: {
  ...
  fs.writeFileSync('members_page.html', html3);
  console.log("Saved members page HTML to members_page.html (Length:", html3.length, ")");
}
