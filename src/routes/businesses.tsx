...
const SUBCATEGORY_META: Record<string, string> = {
  ...
  "Nursery & Cattle":                 UNS("1560493677-af12-c272a1d52f"),
  ...
  "Dry Fruits & Pooja Items":         UNS("1528825-89b7cc-3b21d8"),
  ...
  "Yoga Classes":                     UNS("1544367654-81-b21d"),
  // Electricals & Electronics
  ...
  // Nursery & Plants
  "Plant Nursery":                    UNS("1416879595882-3373a0480b5b"),
  // Organic Products
  ...
  "PG, Hostels & Rooms":              UNS("1555854338-80-d2de"),
  ...
  // Sports
  "Cycling":                          UNS("1558618666-fcd25c85cd64"),
  ...
  "Swimming Clubs":                   UNS("1560089168-6516080f-a3c1"),
...
const CATEGORY_IMAGE_POOLS: Record<string, string[]> = {
  ...
  "Advertising": [
    ...
    UNS("1562776977-f5db5477e89c"), UNS("1611162618479-ee0d6e52edba"), UNS("1533750349088-cd871a92f312"),
    UNS("1538688525198-9b8d0a6a8d0a"), UNS("1508166785545-5e8a3cbb5bc8"), UNS("1563986769-609-a3b7f3a2f"),
    UNS("1542744173-8e7e53415bb0"), UNS("1559136555-9303bafe527e"), UNS("1532619187608-e5375cab36aa"),
  ],
  "Finance & Banking": [
  ...
  "Courier Services": [
    ...
    UNS("1494412574-383eba0-58b9"), UNS("1612865547977-32e7e26dc20e"), UNS("1574688636-61ede2524cb9"),
  ...
  "Packers & Movers": [
    ...
    UNS("1578575437130-527eed3ff0f5"), UNS("1494412574-383eba0-58b9"), UNS("1553413077-190dd305b4ea"),
  ...
  "Repairs": [
    ...
    UNS("1504890536015-c5d7a3e52db4"), UNS("1582721478116-b0-a69bff3e"), UNS("1518770660439-4636190af475"),
  ...
  "B2B Services": [
    ...
    UNS("1561489396-9a7fc9a34e35"), UNS("1600880292203-757bb62b2f72"), UNS("1553877522-43269d4ea984"),
  ],
  "Travel & Tourism": [
  ...
  "Nursery & Plants": [
    ...
    UNS("1454165804606-c3d57bc86b40"), UNS("1491895200222-0fc4a4c35e5c"), UNS("1558615069-dda88a1d5440"),
  ],
  "Demand Services": [
  ...
  "Hire Services": [
    UNS("1492144534655-ae79c964c9d7"), UNS("1556909114-f6e7ad7d3136"), UNS("1555041469-a586c61ea9bc"),
    UNS("1503376780353-7e6692767b70"), UNS("1519003722824-194d4455a60c"), UNS("1568702846914-96b305d2aaeb"),
    UNS("1558618047-3c8c76ca7d13"), UNS("1552519507-da3b142862c3"), UNS("1580273916550-22af8dba4fc0"),
    UNS("1544620347-c4fd4a3d5957"), UNS("1568702846914-96b305d2aaeb"), UNS("1449965408869-00c17c2513ae"),
  ],
  "Bills & Recharge": [
    UNS("1556742049-0cfed4f6a45d"), UNS("1550751827-4bd374c3f58b"), UNS("1478720568477-152d9b92543f"),
    UNS("1518770660439-4636190af475"), UNS("1512941937669-90a1b58e7e9c"), UNS("1607799279861-4dd421887179"),
    UNS("1607083206869-4c7672ac72e8"), UNS("1601784551446-a3a8a5893f4f"), UNS("1587321115-5cf00dfa-5a3b"),
    UNS("1585771724684-38796367a489"), UNS("1580121058729-87d4f928dece"), UNS("1555952494-602d8c18bab0"),
  ],
  "Hardware & Tools": [
    UNS("1572981779307-38b8cabb2407"), UNS("1581092921461-eab62e97a780"), UNS("1504890536015-c5d7a3e52db4"),
    UNS("1530811761207-8d9d22f0a9bd"), UNS("1504307651254-35680f356dfd"), UNS("1517581177683-2531ec1a18e8"),
    UNS("1558618047-3c8c76ca7d13"), UNS("1565538810643-e6cfe01bfee6"), UNS("1589939705384-5185137a7f0f"),
    UNS("1567538096630-e6a00f535d13"), UNS("1617347454861-3db8701e4f55"), UNS("1508450859948-4e04fabaa4ea"),
  ],
};

// General fallback pool used when no category match
const GENERAL_POOL: string[] = [
  ...
  UNS("1573496359142-b8d87734a5a2"), UNS("1565688534549-b44570a0f2a1"), UNS("1525338078-ux4s2a7xb4r"),
...
function getBusinessImage(b: Business): string {
  ...
  // Try category pool first (most specific)
...
async function fetchSubcategories(category: string): Promise<string[]> {
  try {
    ...
    if (data.subcategories && Array.isArray(data.subcategories)) {
      return data.subcategories.map((item: any) =>
        typeof item === "string" ? item : item.subCategory || item.name || String(item)
      ).filter(Boolean);
    }
